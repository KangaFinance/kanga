 ...
 *
 * Run this file with scripts/_runMasterBreederV2Simplified.sh
 */
...
methods {
	...
	// overrided methods
	kangaPerBlock() returns (uint256 amount)
	...
	// KANGA token
	KANGA() returns (address) envfree // NOT USED
	kangaToken.balanceOf(address) returns (uint256) // NOT USED
	...
	// Rewarder
	// SIG_ON_KANGA_REWARD = 0xbb6cc2ef; // onKangaReward(uint256,address,uint256)
	0xbb6cc2ef => NONDET
