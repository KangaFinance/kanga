...
//TODO Harmony Testnet router needs to be updated after each deploy
UNISWAP_ROUTER.set("1666700000", "0x9c299D2aec5Bf5F247A98a6560655E7b002F771E")
...
module.exports = async function ({ getNamedAccounts, getChainId, deployments }) {
  ...
  const kangaRouterAddress = (await deployments.get("UniswapV2Router02")).address

  await deploy("KangaBounce", {
    from: deployer,
    args: [uniswapRouterAddress, kangaRouterAddress],
    log: true,
    deterministicDeployment: false
  })
}

module.exports.tags = ["KangaBounce"]
